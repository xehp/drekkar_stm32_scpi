...
OBJS += src/eeprom.o
OBJS += src/mathi.o
OBJS += src/measuringFilter.o
OBJS += src/machineState.o
#OBJS += src/measuring.o
OBJS += src/cmd.o
...
OBJS += src/relay.o
OBJS += src/scan.o
OBJS += src/supervise.o
OBJS += src/translator.o
OBJS += src/externalSensor.o
OBJS += src/externalTemp.o
OBJS += src/externalCurrentLeakSensor.o
OBJS += src/pwm1.o
OBJS += src/portsGpio.o
